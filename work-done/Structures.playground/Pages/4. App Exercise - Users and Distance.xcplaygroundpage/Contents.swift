...
var hargun = User(name: "Hargun", age: 21, height: 180, weight: 80, activityLevel: 8)
print("\(hargun.name), \(hargun.age), \(hargun.height), \(hargun.weight), \(hargun.activityLevel)")
...
let otherDistance = Distance(f: 300)
