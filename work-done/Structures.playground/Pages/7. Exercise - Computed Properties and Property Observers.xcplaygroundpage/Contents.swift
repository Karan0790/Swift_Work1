...
let myRectangle = Rectangle(width: 8, height: 6)
...
struct Height {
    var heightInInches: Double {
           didSet {
               ...
               if abs(heightInCentimeters - calculatedCentimeters) > 0.001 {
       ...
       var heightInCentimeters: Double {
           didSet {
               ...
               if abs(heightInInches - calculatedInches) > 0.001 {
...
print("Initially in cm: \(myHeight.heightInCentimeters)")
myHeight.heightInInches = 70
print("Updated in cm: \(myHeight.heightInCentimeters)")
myHeight.heightInCentimeters = 180
print("Updated in inches: \(myHeight.heightInInches)")
