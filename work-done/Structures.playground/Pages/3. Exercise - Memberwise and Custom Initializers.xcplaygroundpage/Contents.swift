...
let favoriteBook = Book(title: "New Book", author: "ABC", pages: 240, price: 400)
...
let lap1 = Laptop(yearPurchased: 2023)
let lap2 = Laptop(screenSize: 44,repairCount: 20000, yearPurchased: 2025,)
...
print("heightInInches \(someonesHeight.heightInInches), heightInCentimeters: \(someonesHeight.heightInCentimeters)")
...
print("heightInInches \(myHeight.heightInInches), heightInCentimeters: \(myHeight.heightInCentimeters)")
